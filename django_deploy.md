...
$ ssh-keygen
```
and point to id_rsa_do in ./.ssh/ folder
...
```
# e.g. ssh root@206.189.140.96

# Permission Denied (fix it by running )
ssh-add ./.ssh/keyfilename
# e.g. ssh-add ./.ssh/id_rsa_do
...
```
# adduser djangoadmin - Pwd admin123
```
...
## Go to main project folder btre_project and on Virtual Env of Source Code and do
source ./venv/bin/activate
